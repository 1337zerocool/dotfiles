...
```sh
brew install cmake coreutils fzf gawk gh git grep gsed jq btop neovim openssh openssl pup watchman ripgrep sqlite tree-sitter wget zsh zsh-autosuggestions zsh-fast-syntax-highlighting
```
